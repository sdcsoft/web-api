 ...
 */
@RestController
@RequestMapping(value = "/webapi/endusermanage/user", produces = "application/json;charset=utf-8")
@Auth
public class EndUserManage_UserController {

    @Autowired
    private EndUser_DB_ProductUserMapper productUserMapper;
    @Autowired
