...
import cn.com.sdcsoft.webapi.mapper.EndUser_DB.EndUser_DB_CustomerMapper;
import cn.com.sdcsoft.webapi.web.endusermanage.entity.Customer;
 ...
 */
@RestController
@RequestMapping(value = "/webapi/endusermanage/customer", produces = "application/json;charset=utf-8")
@Auth
public class EndUserManage_CustomerController {

    @Autowired
    private EndUser_DB_CustomerMapper customerMapper;
