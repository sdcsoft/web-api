...
import cn.com.sdcsoft.webapi.web.endusermanage.entity.RoleResource;
 ...
 */
@RestController
@RequestMapping(value = "/webapi/endusermanage/role", produces = "application/json;charset=utf-8")
@Auth
public class EndUserManage_RoleController {

    @Autowired
    private EndUser_DB_RoleMapper roleMapper;
