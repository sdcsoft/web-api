 ...
 */
@RestController
@RequestMapping(value = "/webapi/enterprise/repairinfo", produces = "application/json;charset=utf-8")
@Auth
public class EnterpriseManage_RepairInfoController {

    @Autowired
    Enterprise_DB_RepairInfoMapper repairInfoMapper;
