...
import cn.com.sdcsoft.webapi.mapper.Enterprise_DB.Enterprise_DB_CustomerMapper;
import cn.com.sdcsoft.webapi.web.enterprisemanage.entity.Customer;
 ...
 */
@RestController
@RequestMapping(value = "/webapi/enterprise/customer", produces = "application/json;charset=utf-8")
@Auth
public class EnterpriseManage_CustomerController {

    @Autowired
    private Enterprise_DB_CustomerMapper customerMapper;
