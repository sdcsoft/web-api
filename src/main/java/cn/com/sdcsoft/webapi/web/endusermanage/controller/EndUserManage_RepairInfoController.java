...
import cn.com.sdcsoft.webapi.mapper.EndUser_DB.EndUser_DB_RepairInfoMapper;
import cn.com.sdcsoft.webapi.web.endusermanage.entity.RepairInfo;
 ...
 */
@RestController
@RequestMapping(value = "/webapi/endusermanage/repairinfo", produces = "application/json;charset=utf-8")
@Auth
public class EndUserManage_RepairInfoController {

    @Autowired
    EndUser_DB_RepairInfoMapper repairInfoMapper;
