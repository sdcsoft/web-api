...
import cn.com.sdcsoft.webapi.mapper.Enterprise_DB.Enterprise_DB_RoleMapper;
 ...
 */
@RestController
@RequestMapping(value = "/webapi/enterprise/role", produces = "application/json;charset=utf-8")
@Auth
public class EnterpriseManage_RoleController {

    @Autowired
    private Enterprise_DB_RoleMapper roleMapper;
